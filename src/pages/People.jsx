...
// Existing headshots — retained for the 2025–26 archive
      ...
      <div className="relative aspect-[4/5] overflow-hidden border-b border-black">
        {image ? (
          ...
          <div className="w-full h-full bg-[#f5f5f5] flex items-center justify-center">
            <span className="text-4xl font-serif font-medium tracking-tight text-black/70">
              {getInitials(name)}
            </span>
          </div>
        )}
  ...
  return (
    ...
    >
      {linkedin ? (
        ...
        <div className="group block bg-white border border-black transition-all duration-300 hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] h-full">
          {cardContent}
        </div>
      )}
    </motion.div>
...
const People = () => {
  ...
  // BOARD DATA
  //
  // Each academic year maintains its own names, positions,
  // photos, emails, and links. This allows titles and the
  // organizational structure to change from year to year.
  // =========================================================

  const boards = {

    // =========================
    // 2026–27 CURRENT BOARD
    // =========================
    ...
    '2026-27': {
      ...
      executiveBoard: [
        {
          name: 'Christopher Dsouza',
          position: 'President',
          email: 'cd1001@scarletmail.rutgers.edu',
          linkedin: 'https://www.linkedin.com/in/cdsouza1001/',
          image: c_dsouza
        },
        {
          name: 'Julia Rhodes',
          position: 'Treasurer',
          email: 'jr1896@scarletmail.rutgers.edu',
          linkedin: 'https://www.linkedin.com/in/julia-o-rhodes/',
          image: j_rhodes
        },
        {
          ...
          linkedin: 'https://www.linkedin.com/in/katarina-latinovic-a49028288/',
          image: k_latinovic
        },
        {
          name: 'Giselle Darko',
    ...
    '2025-26': {
      ...
      executiveBoard: [
        {
          name: 'Eric Wenz',
          position: 'President',
          email: 'ecw79@scarletmail.rutgers.edu',
          linkedin: 'https://www.linkedin.com/in/ericwenz/',
          image: e_wenz
        },
        {
          name: 'Nashwa Faruk',
          position: 'Treasurer',
          email: 'nf369@scarletmail.rutgers.edu',
          linkedin: 'https://www.linkedin.com/in/nashwa-faruk/',
          image: n_faruk
        },
        {
          name: 'Julia Rhodes',
        ...
        },
        {
          ...
          email: 'pw342@scarletmail.rutgers.edu',
          linkedin: 'https://www.linkedin.com/in/peleg-wolfsohn-124b14277/',
          image: p_wolfsohn
        },
        {
          name: 'Shruthika Parsa',
          position: 'Director of Marketing',
          email: 'sp2222@scarletmail.rutgers.edu',
          linkedin: 'https://www.linkedin.com/in/shruthikaparsa/',
          image: s_parsa
        },
        {
          name: 'Benjamin Abrams',
          position: 'Director of Communications',
          email: 'benjamin.abrams@rutgers.edu',
          linkedin: 'https://www.linkedin.com/in/benjamin-abrams-ru/',
          image: b_abrams
        },
        {
          name: 'Christopher Dsouza',
      ...
      initiativeLeaders: [
        {
          name: 'Annabelle Hinks',
          position: 'DRP Coordinator',
          email: 'ajh291@scarletmail.rutgers.edu',
          linkedin: 'https://www.linkedin.com/in/annabelle-hinks/',
          image: a_hinks
        },
        {
          name: 'Katarina Latinović',
          position: 'Research Journal Editor-In-Chief',
          email: 'kl1232@scarletmail.rutgers.edu',
          linkedin: 'https://www.linkedin.com/in/katarina-latinovic-a49028288/',
          image: k_latinovic
        },
        {
          name: 'Kushaan Jain',
          position: 'REL President',
          email: 'kj448@scarletmail.rutgers.edu',
          linkedin: 'https://www.linkedin.com/in/kushaanjain/',
          image: k_jain
        },
        {
          name: 'Akash Dubey',
          position: 'REL Research Director',
          email: 'ad2046@scarletmail.rutgers.edu',
          linkedin: 'https://www.linkedin.com/in/akash-dubey-your-boss/',
          image: a_dubey
        },
        {
          ...
          email: 'ssg163@scarletmail.rutgers.edu',
          linkedin: 'https://www.linkedin.com/in/salilgarud/',
          image: s_garud
        },
        {
          name: 'Sanjana Pundru',
          position: 'Newsletter Co-Editor-In-Chief',
          email: 'sp2425@scarletmail.rutgers.edu',
          linkedin: 'https://www.linkedin.com/in/sanjana-pundru/',
          image: s_pundru
        }
      ]
    }
  ...
  const currentBoard = boards[selectedYear];
  ...
  return (
    <div className="bg-white min-h-screen font-serif">
      ...
      <PageMeta
        title="People"
        description="Meet the RECONS Executive Board and Initiative Leaders at Rutgers University."
        path="/people"
      />
      ...
      <section className="pt-32 pb-16 border-b border-black/5 bg-[#fafafa]">
        <div className="max-w-6xl mx-auto px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-10">
            ...
            >
              <h1 className="text-5xl md:text-6xl font-medium uppercase tracking-tighter text-black">
                The Team
              </h1>
            ...
            <div className="flex flex-col gap-2">
              ...
              <label
                htmlFor="board-year"
                className="text-[9px] uppercase tracking-[0.25em] text-gray-500"
              >
                Academic Year
              </label>
              ...
              <select
                ...
                className="bg-transparent border-b border-black py-2 pr-10 text-sm uppercase tracking-[0.15em] cursor-pointer focus:outline-none"
              >
      ...
      <div className="max-w-6xl mx-auto py-20 px-8">
        ...
        <div className="mb-24">
          ...
          <div
            key={`executive-${selectedYear}`}
            className="flex flex-wrap justify-center gap-8"
          >
            {currentBoard.executiveBoard.map((person, i) => (
              <PersonCard
                key={`${selectedYear}-board-${person.name}`}
                {...person}
                index={i}
              />
            ))}
        ...
        <div>
          ...
          <div
            key={`initiatives-${selectedYear}`}
            className="flex flex-wrap justify-center gap-8"
          >
            {currentBoard.initiativeLeaders.map((person, i) => (
              <PersonCard
                key={`${selectedYear}-lead-${person.name}`}
                {...person}
                index={i}
              />
            ))}
