    ...
    <div className="bg-[#fafafa] min-h-screen py-24 px-8 text-black">
      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-16">
            <div className="md:w-2/3">
              <p className="text-2xl md:text-3xl font-serif leading-relaxed text-gray-800">
                ...
                the Buddy Program helps students navigate the economics major
                and sets them up for success in job hunting and expanding
                their network.
              </p>
              ...
              <p className="mt-8 text-lg text-gray-600 font-serif leading-relaxed">
                ...
                on holistic development. Participants become part of a
                close-knit network of students who support one another
                academically and personally. By sharing experiences and lessons
                learned, mentors help incoming undergraduates feel connected,
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-20 text-center">
              ...
              <p className="text-xl font-serif italic text-gray-500 leading-relaxed max-w-2xl mx-auto">
                We seek mentors who are not just high-achievers, but empathetic
                guides committed to the success of their peers.
              </p>
            </div>
            ...
            <div className="space-y-0">
              {[
                ...
                <div
                  key={idx}
                  className="group border-t border-black py-12 flex flex-col md:flex-row gap-8 transition-colors hover:bg-black/5"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
          ...
          {/* Mentor Application */}
          <div className="border-2 border-black transition-all hover:shadow-[15px_15px_0px_0px_rgba(0,0,0,1)]">
            <div className="p-12 md:p-16 bg-white flex flex-col items-center text-center h-full">

              <h3 className="text-3xl font-serif font-medium uppercase mb-6">
                Become a Mentor
              </h3>

              <p className="text-gray-500 font-serif leading-relaxed mb-10 flex-grow">
                Share your experiences at Rutgers, offer advice, and help a
                fellow member navigate academics, clubs, and internships
                specific to economics.
              </p>

              <a
                href="https://forms.gle/HbMhzkvvndf8jTvE6"
                target="_blank"
          ...
          <div className="border-2 border-black transition-all hover:shadow-[15px_15px_0px_0px_rgba(0,0,0,1)]">
            <div className="p-12 md:p-16 bg-white flex flex-col items-center text-center h-full">
              ...
              <p className="text-gray-500 font-serif leading-relaxed mb-10 flex-grow">
                Get personalized guidance from a fellow RECONS member, ask
                questions about career paths and opportunities at Rutgers,
                and expand your network.
              </p>

              <a
                href="https://forms.gle/FfVjC7RFXT68EYoa8"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full group"
              >
