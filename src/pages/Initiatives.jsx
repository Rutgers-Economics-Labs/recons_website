      ...
      <div className="flex flex-wrap gap-6 mt-auto">
        {links.map((link, index) => (
          link.url ? (
            ...
            <span 
              key={index} 
              className="text-xs font-serif uppercase tracking-[0.2em] font-bold text-gray-400 cursor-default"
            >
              {link.text}
            </span>
          )
  ...
  const mainInitiatives = [
    {
      ...
      links: [
        { text: "Coming Fall 2026", url: "" } // URL is empty
      ]
    },
    {
      title: "Competitions",
